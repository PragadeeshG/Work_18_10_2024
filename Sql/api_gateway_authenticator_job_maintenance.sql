create table if not exists api_gateway_authenticator_job_maintenance(
oauth_control_id Integer not null,
down_time_appicable varchar(255) null,
...
constraint api_gateway_authenticator_job_maintenance_pk primary key(oauth_control_id));
